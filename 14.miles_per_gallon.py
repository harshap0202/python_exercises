...
# of gallons of gas that the car's fuel tank holds. The second variable represents the miles that the car can travel on a full tank before needing a refuel.
...
# car manufacturers sometimes exaggerate miles per gallon.  In addition, display the values held in the variables you created for gallons of gas in the car's 
# fuel tank and miles it can travel on a full tank with two different print statements.
...
print("Car can travel " + str(miles // gallons) + " miles pre gallon")
print("Car can travel " + str(miles)+ " miles on a full tank")
print("Car's tank can hold " + str(gallons) + " gallons of fuel")