...
# For this programming challenge, you will be creating a function that calculates the volume of a rectangular prism in cubic feet.
...
print("The volume of the rectangular prism is " + str(vol_calc(length, width, height)) + " cubic feet.")
