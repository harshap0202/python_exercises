...
if score >= 90:
    print("Student has scored " + str(score) + " so gets Grade A")
else:
    if score >= 80:
        print("Student has scored " + str(score) + " so gets Grade B")
    else:
        if score >= 70:
            print("Student has scored " + str(score) + " so gets Grade C")
        else:
            if score >= 60:
                print("Student has scored " + str(score) + " so gets Grade D")
            else:
                print("Student has scored " + str(score) + " so gets Grade F")
