...
string1 = "James Bond is 007."
string2 = "When the moon hits your eye like a big pizza pie, that's amore!"
string3 = "Anyway, like I was sayin', shrimp is the fruit of the sea. You can barbecue it, boil it, broil it, bake it, \
saute it. Dey's uh, shrimp-kabobs, shrimp creole, shrimp gumbo. Pan fried, deep fried, stir-fried. There's pineapple \
shrimp, lemon shrimp, coconut shrimp, pepper shrimp, shrimp soup, shrimp stew, shrimp salad, shrimp and potatoes, \
shrimp burger, shrimp sandwich. That- that's about it."
...
def word_counter(words):
    ...
    for word in words:
        if word.isalnum() or word.isspace() or word == "-" or word == "'":
            new_string += word
...
print(word_counter(string2))
print(word_counter(string3))